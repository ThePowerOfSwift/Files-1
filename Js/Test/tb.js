    ...
    list.forEach((item, index) => {
        if (item.length > 0) {
            ...
            if (index == 0) {
                ...
                lowest180 = { Name: "180天最低", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
                lowest360 = { Name: "360天最低", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
            }
